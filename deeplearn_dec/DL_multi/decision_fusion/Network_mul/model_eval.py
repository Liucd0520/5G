...
train_ds = CacheDataset(data=train_dict, transform=val_transforms, cache_rate=0.1, num_workers=12)
...
model.load_state_dict(torch.load("best_metric_model_classification3d_dict.pth", map_location=device))
