...
class DoubleTower(nn.Module):
    def __init__(self,
        ...
        self.attn = nn.MultiheadAttention(512, num_heads=8, device=self.device)
        ...
        self.Linear2 = Linear(512 + 6, self.num_classes, device=self.device)
    ...
    def forward(self, x1, x2, structured_data):  # x 是SegResNet的输入影像矩阵
        ...
        fc2 = self.Linear2( torch.concat([concatenated, structured_data], dim=-1))
