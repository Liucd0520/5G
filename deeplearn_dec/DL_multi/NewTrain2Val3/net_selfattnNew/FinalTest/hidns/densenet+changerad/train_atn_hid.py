...
rad_features = ['patient_id', 
 'adc-delta-wavelet-LHH_glszm_SmallAreaLowGrayLevelEmphasis',
 'dce-delta-log-sigma-5-0-mm-3D_glcm_Idn',
 'dce-bf-log-sigma-3-0-mm-3D_firstorder_Skewness',
 'dce-delta-log-sigma-5-0-mm-3D_glszm_ZoneEntropy',
 'dce-bf-wavelet-LHL_glcm_Imc2',
 'dce-delta-log-sigma-5-0-mm-3D_glrlm_ShortRunEmphasis',
 'adc-delta-wavelet-LLH_firstorder_RobustMeanAbsoluteDeviation',
 'dce-delta-log-sigma-5-0-mm-3D_glcm_Idmn',
 'adc-delta-original_gldm_SmallDependenceHighGrayLevelEmphasis',
 'adc-bf-log-sigma-4-0-mm-3D_glcm_Correlation',
 'dce-bf-wavelet-LHL_glcm_Correlation',
 'adc-bf-wavelet-HLL_firstorder_Median',
 'adc-delta-log-sigma-3-0-mm-3D_glcm_Correlation',
 'dce-bf-wavelet-LHH_firstorder_Mean',
 'dce-bf-log-sigma-4-0-mm-3D_glcm_InverseVariance',
 'adc-delta-wavelet-LHL_glrlm_LongRunLowGrayLevelEmphasis',
 'dce-bf-wavelet-LLL_glcm_Idn',
 'dce-bl-wavelet-LHL_glcm_Correlation',
 'adc-bf-wavelet-LLH_glcm_ClusterShade',
 'dce-bl-wavelet-LHH_firstorder_Median',
 'adc-delta-wavelet-LLL_firstorder_Minimum',
 'dce-bf-wavelet-HHL_firstorder_Median',
 'dce-bf-log-sigma-5-0-mm-3D_gldm_DependenceEntropy',
 'adc-delta-log-sigma-5-0-mm-3D_firstorder_Kurtosis',
 'dce-bf-wavelet-HLL_firstorder_Skewness',
 'dce-bf-log-sigma-2-0-mm-3D_firstorder_Skewness',
 'dce-bf-wavelet-HLL_firstorder_Median',
 'adc-delta-wavelet-LHL_glcm_Idn',
 'adc-delta-log-sigma-4-0-mm-3D_gldm_DependenceNonUniformityNormalized',
 'adc-bl-log-sigma-4-0-mm-3D_firstorder_Kurtosis',
 'dce-bf-wavelet-LHH_glszm_SizeZoneNonUniformityNormalized',
 'adc-delta-log-sigma-2-0-mm-3D_glrlm_LongRunLowGrayLevelEmphasis',
 'adc-delta-original_glcm_Correlation'
 ]
...
for epoch in range(max_epochs):
    ...
    for batch_data in train_loader:
        step += 1
        input_dce, input_adc, input_rad,  input_clinical, labels = batch_data["image_dce"].to(device), batch_data['image_adc'].to(device), batch_data["rad"].to(device), batch_data["clinical"].to(device), batch_data["label"].to(device)
        
        optimizer.zero_grad()
        outputs = model(input_dce, input_adc, input_rad, input_clinical)
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        with torch.no_grad():
            ...
            tot_metric = auc_result+acc_metric+trainval_acc_metric+trainval_auc_result

            if tot_metric > best_metric and trainval_auc_result > 0.86:
