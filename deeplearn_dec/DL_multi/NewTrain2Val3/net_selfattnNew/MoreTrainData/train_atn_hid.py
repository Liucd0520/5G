...
sd_dcedir = '/app/liucd/deeplearn_dec/DL_dec/data_big/shandong/Mixed'
...
train_adcpcrimages = sorted(glob.glob(os.path.join(sd_adcpcrdir,  '*.nii.gz')))[:80] 
...
train_dcepcrimages = sorted(glob.glob(os.path.join(sd_dcepcrdir,  '*.nii.gz')))[:80] 
