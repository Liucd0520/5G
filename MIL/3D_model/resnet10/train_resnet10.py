...
class DoubleTower(nn.Module):
    def __init__(self,
        ...
        self.model_dce = monai.networks.nets.resnet10(spatial_dims=3, n_input_channels=1, num_classes=2, feed_forward=False).to(self.device)
        self.model_adc = monai.networks.nets.resnet10(spatial_dims=3, n_input_channels=1, num_classes=2, feed_forward=False).to(self.device)
