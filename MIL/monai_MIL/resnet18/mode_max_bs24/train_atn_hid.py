...
class DoubleTower(nn.Module):
    def __init__(self,
        ...
        self.Linear1 = Linear(512*4, self.fc_hidden_size, device=self.device)  # 1024 是 所有下采样特征图globalpool之后拼接的结果
...
for epoch in range(max_epochs):
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        with torch.no_grad():
            ...
            tot_metric = auc_result+acc_metric

            if tot_metric > best_metric and auc_result > 0.78:
